...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-07-2025 a las 02:40:16
...
(7, 'Canadá', 'CA', 'Dólar canadiense', 'CAD', 0.000340),
...
(20, 'México', 'MX', 'Peso mexicano', 'MXN', 0.004600),
...
--
ALTER TABLE `arancel`
  MODIFY `id_arancel` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `exportacion`
  MODIFY `id_exportacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
